...
export default class HelloWorldScene extends Phaser.Scene
{
    ...
    create(){
       ...
       ground
        ...
        this.physics.add.collider(this.player, this.platforms) //collider so that the player will stay in the platform
        ...
        this.physics.add.collider(this.stars, this.platforms) //collider so that the star will stay in the platform
    ...
    private handleCollectStar(player: Phaser.GameObjects.GameObject, s: Phaser.GameObjects.GameObject){
        ...
        star.disableBody(true,true)         //this makes the star disappear as as soon as the player collides with the star
